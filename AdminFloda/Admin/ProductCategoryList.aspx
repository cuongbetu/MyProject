<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ProductCategoryList.aspx.cs" Inherits="Admin_ProductCategory" %>
                ...
                <div class="block-fluid">
                    ...
                    <div class="row-form clearfix" style="padding: 7px 16px;">
                        <asp:DropDownList ID="DropDownList_Cat"
                            ...
                            AutoPostBack="true"
                            runat="server" />
                        <span style="text-align: center; display: block;">Loại sản phẩm cấp 1.</span>
                    </div>
                    <!--Loại Cấp Con-->
                    <div class="row-form clearfix">
                        <asp:DropDownList size="4" class="category"
                            Style="height: 481px;" ID="DropDownList_Main"
